...
Regenerate with:  python build_task_tracker.py
...
TASKS = [
    ...
    ("S3", "Conversation-intent scenarios + scripted trees (17 intents)",
     ...
     "tests/test_conversation_intents.py — 73 tests green. Commits 9840cb0, 78aedf0"),
    ...
    ("P1", "Two-person work split + daily git workflow (POA/18)",
     ...
     "POA/18_Team_Work_Split_and_Git_Workflow.md, POA/00 index. Commits d1f6987, 3f444b8"),
